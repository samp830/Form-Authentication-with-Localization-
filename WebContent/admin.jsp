...
<ul>
  <li class="current-menu-item"><a href="#"><fmt:message key="Welcome_Admin"/></a></li>
 ...
 <li><a href="#"><fmt:message key="Settings"/></a>
    <ul>
      <li class="dir"><a href="#"><fmt:message key="Download"/></a></li>
      <li class="dir"><a href="#"><fmt:message key="Reports"/></a></li>
     </ul>
</nav>
    </body>
